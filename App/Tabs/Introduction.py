...
def Bank_Animation():   
    animation = st_lottie(
        animation_file(r"Tabs/Animations/Bank.json"),
        speed = 1,
        reverse = False,
        loop = True,
        quality = "high"
...
def Thinking_Animation():   
    animation = st_lottie(
        animation_file(r"Tabs/Animations/Thinking.json"),
        speed = 1,
        reverse = False,
        loop = True,
        quality = "high"
...
def UpTrend_Animation():   
    animation = st_lottie(
        animation_file(r"Tabs/Animations/UpTrend.json"),
        speed = 1,
        reverse = False,
        loop = True,
        quality = "high"
...
def DownTrend_Animation():   
    animation = st_lottie(
        animation_file(r"Tabs/Animations/DownTrend.json"),
        speed = 1,
        reverse = False,
        loop = True,
        quality = "high"
...
def Speedometer_Animation():   
    animation = st_lottie(
        animation_file(r"Tabs/Animations/Speedometer.json"),
        speed = 1,
        reverse = False,
        loop = True,
        height=400, 
