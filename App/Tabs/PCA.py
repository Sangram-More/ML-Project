...
file_path = r"App/Tabs/Images/PCA_Explained_Varience.png"
st.image(file_path)
...
file_path = r"App/Tabs/Images/PCA_Projection.png"
st.image(file_path)
...
file_path = r"App/Tabs/Images/PCA_Scree_Plot.png"
st.image(file_path)
...
file_path = r"App/Tabs/Images/PCA_Loading_Plot.png"
st.image(file_path)
...
with column1_1:
    file_path = r"App/Tabs/Animations/PCA_Original_Dataset.gif"
    st.image(file_path)

with column2_1:
    file_path = r"App/Tabs/Animations/PCA_Transformed_Dataset.gif"
    st.image(file_path)
...
file_path = r"App/Tabs/Images/PCA_Values.png"
st.image(file_path)
